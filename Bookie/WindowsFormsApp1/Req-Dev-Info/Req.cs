...
namespace WindowsFormsApp1
{
    public partial class Req : Form
    {
        ...
        private void Requisitar_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(ex.Message, "Erro no Load do Form Req", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally
            {
                con.Close();
        ...
        private void Req_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(ex.Message, "Erro no Botão de Requisitar", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally
            {
                con.Close();
